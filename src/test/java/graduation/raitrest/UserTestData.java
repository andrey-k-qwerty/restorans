...
//    public static final int MANAGER_3_ID = START_SEQ + 1;
    ...
    public static final User MANAGER = new User(MANAGER_ID, "Manager", "manager@yandex.ru", "manager", Role.ROLE_ADMIN);
    ...
    public static final User MANAGER_1 = new User(MANAGER_1_ID, "Manager_1", "manager_1@yandex.ru", "1password", Role.ROLE_ADMIN);
    public static final User MANAGER_2 = new User(MANAGER_2_ID, "Manager_2", "manager_2@yandex.ru", "2password", Role.ROLE_ADMIN);
    public static final User MANAGER_3 = new User(MANAGER_3_ID, "Manager_3", "manager_3@yandex.ru", "3password", Role.ROLE_ADMIN);
