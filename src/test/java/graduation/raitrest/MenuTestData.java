...
//    public static final Menu MENU_STAR = new Menu(MENU_ID, "Star_meal_dinner", new Date(), RestoranTestData.RESTAURANT_STAR);
//    public static final Menu MENU_PEARL = new Menu(MENU_ID + 1, "Pearl_meal_dinner", new Date(), RestoranTestData.RESTAURANT_PEARL);
...
//
//    public static final Menu MENU_STAR_1D = new Menu(MENU_ID + 5, "Star_meal_lunch", new Date((new Date()).getTime() - 86400000), RestoranTestData.RESTAURANT_STAR);
//    public static final Menu MENU_PEARL_1D = new Menu(MENU_ID + 6, "Pearl_meal_lunch", new Date((new Date()).getTime() - 86400000), RestoranTestData.RESTAURANT_PEARL);
...
//
//    public static final Menu MENU_STAR_2D = new Menu(MENU_ID +10, "Star_meal_breakfast", new Date((new Date()).getTime() - 172800000), RestoranTestData.RESTAURANT_STAR);
//    public static final Menu MENU_PEARL_2D = new Menu(MENU_ID + 11, "Pearl_meal_breakfast", new Date((new Date()).getTime() - 172800000), RestoranTestData.RESTAURANT_PEARL);
